...
Copyright (C) 2009-2015 Darren Enns <dmenns1@gmail.com>
...
graph_title = "Generated by MGedcom " + VERSION + " © Darren Enns " + str(datetime.date.today().year)
graph_direction = "LR"
...
class show_nice_gedcom:
	...
	def __init__(self, widget, window):
		...
		actiongroup.add_radio_actions([('PNG', None, 'P_NF', None, None, 0),
