...
gedcom_dir = os.path.expanduser(ini_file)
dot_dir = os.path.expanduser(ini_file)
graph_title = "Generated by MGedcom " + VERSION + \
    " © Darren Enns " + str(datetime.date.today().year)
graph_direction = "LR"
...
class show_nice_gedcom:
	...
	<menuitem action="PDF"/>
	<menuitem action="SVG"/>
	<menuitem action="Convert Dot Graph"/>
	</menu>
	</menu>
	<menu action="Reports">
    ...
    def __init__(self, widget, window):
        ...
        window.connect(
            "key-press-event", self.on_key_press_nice_gedcom, window)
        ...
        self.individual_treestore = gtk.TreeStore(
            str, str, str, str, str, str, str, str, str, str, str, str, str, str, str, str)

        # create a family TreeStore
        self.family_treestore = gtk.TreeStore(
        ...
        self.individual_treeview.connect(
            'test-expand-row', self.individual_on_row_expanded)
        self.individual_treeview.connect(
            'cursor-changed', self.individual_cursor_changed)
        self.individual_treeview.set_property(
            "show-expanders", True)  # needed for Maemo
        ...
        self.family_treeview.connect(
            'cursor-changed', self.family_cursor_changed)
        ...
        self.submitter_treeview.connect(
            'cursor-changed', self.submitter_cursor_changed)
        ...
        self.repository_treeview.connect(
            'cursor-changed', self.repository_cursor_changed)
        ...
        self.source_treeview.connect(
            'cursor-changed', self.source_cursor_changed)
        ...
        self.object_treeview.connect(
            'cursor-changed', self.object_cursor_changed)
        ...
        self.submission_treeview.connect(
            'cursor-changed', self.submission_cursor_changed)
        ...
        self.custom_treeview.connect(
            'cursor-changed', self.custom_cursor_changed)
        ...
        self.individual_family_pointers_column = gtk.TreeViewColumn(
            'Spouse\nFamily\nPointer')
        self.set_column_style(self.individual_family_pointers_column)
        self.individual_parent_pointers_column = gtk.TreeViewColumn(
            'Parent\nFamily\nPointer')
        ...
        self.family_husband_pointer_column = gtk.TreeViewColumn(
            'Husband\nPointer')
        self.set_column_style(self.family_husband_pointer_column)
        self.family_husband_given_names_column = gtk.TreeViewColumn(
            'Husband\nGiven\nNames')
        self.set_column_style(self.family_husband_given_names_column)
        self.family_husband_last_name_column = gtk.TreeViewColumn(
            'Husband\nLast\nName')
        ...
        self.family_wife_given_names_column = gtk.TreeViewColumn(
            'Wife\nGiven\nNames')
        self.set_column_style(self.family_wife_given_names_column)
        self.family_wife_last_name_column = gtk.TreeViewColumn(
            'Wife\nLast\nName')
        ...
        self.family_marriage_month_column = gtk.TreeViewColumn(
            'Marriage\nMonth')
        ...
        self.family_children_pointers_column = gtk.TreeViewColumn(
            'Children\nPointers')
        ...
        self.individual_treeview.append_column(
            self.individual_raw_gedcom_column)
        ...
        self.individual_treeview.append_column(
            self.individual_given_names_column)
        self.individual_treeview.append_column(
            self.individual_last_name_column)
        self.individual_treeview.append_column(self.individual_sex_column)
        self.individual_treeview.append_column(
            self.individual_birth_date_column)
        self.individual_treeview.append_column(
            self.individual_birth_year_column)
        self.individual_treeview.append_column(
            self.individual_birth_month_column)
        self.individual_treeview.append_column(
            self.individual_birth_day_column)
        self.individual_treeview.append_column(
            self.individual_death_date_column)
        self.individual_treeview.append_column(
            self.individual_death_year_column)
        self.individual_treeview.append_column(
            self.individual_death_month_column)
        self.individual_treeview.append_column(
            self.individual_death_day_column)
        # self.individual_treeview.append_column(self.individual_delete_column)
        self.individual_treeview.append_column(
            self.individual_family_pointers_column)
        self.individual_treeview.append_column(
            self.individual_parent_pointers_column)
        ...
        self.family_treeview.append_column(
            self.family_husband_given_names_column)
        self.family_treeview.append_column(
            self.family_husband_last_name_column)
        ...
        self.family_treeview.append_column(
            self.family_children_pointers_column)
        ...
        self.repository_treeview.append_column(
            self.repository_raw_gedcom_column)
        ...
        self.submission_treeview.append_column(
            self.submission_raw_gedcom_column)
        ...
        # add the individual cells to the individual columns and allow them to
        # expand
        self.individual_raw_gedcom_column.pack_start(
            self.individual_raw_gedcom_cell, True)
        self.individual_type_column.pack_start(self.individual_type_cell, True)
        self.individual_pointer_column.pack_start(
            self.individual_pointer_cell, True)
        self.individual_given_names_column.pack_start(
            self.individual_given_names_cell, True)
        self.individual_sex_column.pack_start(self.individual_sex_cell, True)
        self.individual_last_name_column.pack_start(
            self.individual_last_name_cell, True)
        self.individual_birth_date_column.pack_start(
            self.individual_birth_date_cell, True)
        self.individual_birth_year_column.pack_start(
            self.individual_birth_year_cell, True)
        self.individual_birth_month_column.pack_start(
            self.individual_birth_month_cell, True)
        self.individual_birth_day_column.pack_start(
            self.individual_birth_day_cell, True)
        self.individual_death_date_column.pack_start(
            self.individual_death_date_cell, True)
        self.individual_death_year_column.pack_start(
            self.individual_death_year_cell, True)
        self.individual_death_month_column.pack_start(
            self.individual_death_month_cell, True)
        self.individual_death_day_column.pack_start(
            self.individual_death_day_cell, True)
        self.individual_family_pointers_column.pack_start(
            self.individual_family_pointers_cell, True)
        self.individual_parent_pointers_column.pack_start(
            self.individual_parent_pointers_cell, True)

        # add the family cells to the family columns and allow them to expand
        self.family_raw_gedcom_column.pack_start(
            self.family_raw_gedcom_cell, True)
        ...
        self.family_husband_pointer_column.pack_start(
            self.family_husband_pointer_cell, True)
        self.family_husband_given_names_column.pack_start(
            self.family_husband_given_names_cell, True)
        self.family_husband_last_name_column.pack_start(
            self.family_husband_last_name_cell, True)
        self.family_wife_pointer_column.pack_start(
            self.family_wife_pointer_cell, True)
        self.family_wife_given_names_column.pack_start(
            self.family_wife_given_names_cell, True)
        self.family_wife_last_name_column.pack_start(
            self.family_wife_last_name_cell, True)
        self.family_marriage_date_column.pack_start(
            self.family_marriage_date_cell, True)
        self.family_marriage_year_column.pack_start(
            self.family_marriage_year_cell, True)
        self.family_marriage_month_column.pack_start(
            self.family_marriage_month_cell, True)
        self.family_marriage_day_column.pack_start(
            self.family_marriage_day_cell, True)
        self.family_children_pointers_column.pack_start(
            self.family_children_pointers_cell, True)
        ...
        # add the submitter cells to the submitter columns and allow them to
        # expand
        self.submitter_raw_gedcom_column.pack_start(
            self.submitter_raw_gedcom_cell, True)
        self.submitter_type_column.pack_start(self.submitter_type_cell, True)
        self.submitter_pointer_column.pack_start(
            self.submitter_pointer_cell, True)
        self.submitter_name_column.pack_start(self.submitter_name_cell, True)

        # add the repository cells to the repository columns and allow them to
        # expand
        self.repository_raw_gedcom_column.pack_start(
            self.repository_raw_gedcom_cell, True)
        self.repository_type_column.pack_start(self.repository_type_cell, True)
        self.repository_pointer_column.pack_start(
            self.repository_pointer_cell, True)
        ...
        self.source_raw_gedcom_column.pack_start(
            self.source_raw_gedcom_cell, True)
        ...
        self.source_abbreviation_column.pack_start(
            self.source_abbreviation_cell, True)

        # add the object cells to the object columns and allow them to expand
        self.object_raw_gedcom_column.pack_start(
            self.object_raw_gedcom_cell, True)
        ...
        # add the submission cells to the submission columns and allow them to
        # expand
        self.submission_raw_gedcom_column.pack_start(
            self.submission_raw_gedcom_cell, True)
        self.submission_type_column.pack_start(self.submission_type_cell, True)
        self.submission_pointer_column.pack_start(
            self.submission_pointer_cell, True)

        # add the custom cells to the custom columns and allow them to expand
        self.custom_raw_gedcom_column.pack_start(
            self.custom_raw_gedcom_cell, True)
        ...
        # set the individual cells "text" attribute to matching column - retrieve
        # text from that column in individual treestore
        column = 0
        self.individual_raw_gedcom_posn = column
        self.individual_raw_gedcom_column.add_attribute(
            self.individual_raw_gedcom_cell, 'text', column)
        column = column + 1
        self.individual_type_posn = column
        self.generic_type_posn = column
        self.individual_type_column.add_attribute(
            self.individual_type_cell, 'text', column)
        column = column + 1
        self.individual_pointer_posn = column
        self.individual_pointer_column.add_attribute(
            self.individual_pointer_cell, 'text', column)
        column = column + 1
        self.individual_given_names_posn = column
        self.individual_given_names_column.add_attribute(
            self.individual_given_names_cell, 'text', column)
        column = column + 1
        self.individual_last_name_posn = column
        self.individual_last_name_column.add_attribute(
            self.individual_last_name_cell, 'text', column)
        column = column + 1
        self.individual_sex_posn = column
        self.individual_sex_column.add_attribute(
            self.individual_sex_cell, 'text', column)
        column = column + 1
        self.individual_birth_date_posn = column
        self.individual_birth_date_column.add_attribute(
            self.individual_birth_date_cell, 'text', column)
        column = column + 1
        self.individual_birth_year_posn = column
        self.individual_birth_year_column.add_attribute(
            self.individual_birth_year_cell, 'text', column)
        column = column + 1
        self.individual_birth_month_posn = column
        self.individual_birth_month_column.add_attribute(
            self.individual_birth_month_cell, 'text', column)
        column = column + 1
        self.individual_birth_day_posn = column
        self.individual_birth_day_column.add_attribute(
            self.individual_birth_day_cell, 'text', column)
        column = column + 1
        self.individual_death_date_posn = column
        self.individual_death_date_column.add_attribute(
            self.individual_death_date_cell, 'text', column)
        column = column + 1
        self.individual_death_year_posn = column
        self.individual_death_year_column.add_attribute(
            self.individual_death_year_cell, 'text', column)
        column = column + 1
        self.individual_death_month_posn = column
        self.individual_death_month_column.add_attribute(
            self.individual_death_month_cell, 'text', column)
        column = column + 1
        self.individual_death_day_posn = column
        self.individual_death_day_column.add_attribute(
            self.individual_death_day_cell, 'text', column)
        column = column + 1
        self.individual_family_pointers_posn = column
        self.individual_family_pointers_column.add_attribute(
            self.individual_family_pointers_cell, 'text', column)
        column = column + 1
        self.individual_parent_pointers_posn = column
        self.individual_parent_pointers_column.add_attribute(
            self.individual_parent_pointers_cell, 'text', column)
        self.individual_last_posn = column

        # set the family cells "text" attribute to matching column - retrieve text
        # from that column in family treestore
        column = 0
        self.family_raw_gedcom_posn = column
        self.family_raw_gedcom_column.add_attribute(
            self.family_raw_gedcom_cell, 'text', column)
        column = column + 1
        self.family_type_posn = column
        self.family_type_column.add_attribute(
            self.family_type_cell, 'text', column)
        column = column + 1
        self.family_pointer_posn = column
        self.family_pointer_column.add_attribute(
            self.family_pointer_cell, 'text', column)
        column = column + 1
        self.family_husband_pointer_posn = column
        self.family_husband_pointer_column.add_attribute(
            self.family_husband_pointer_cell, 'text', column)
        column = column + 1
        self.family_husband_given_names_posn = column
        self.family_husband_given_names_column.add_attribute(
            self.family_husband_given_names_cell, 'text', column)
        column = column + 1
        self.family_husband_last_name_posn = column
        self.family_husband_last_name_column.add_attribute(
            self.family_husband_last_name_cell, 'text', column)
        column = column + 1
        self.family_wife_pointer_posn = column
        self.family_wife_pointer_column.add_attribute(
            self.family_wife_pointer_cell, 'text', column)
        column = column + 1
        self.family_wife_given_names_posn = column
        self.family_wife_given_names_column.add_attribute(
            self.family_wife_given_names_cell, 'text', column)
        column = column + 1
        self.family_wife_last_name_posn = column
        self.family_wife_last_name_column.add_attribute(
            self.family_wife_last_name_cell, 'text', column)
        column = column + 1
        self.family_marriage_date_posn = column
        self.family_marriage_date_column.add_attribute(
            self.family_marriage_date_cell, 'text', column)
        column = column + 1
        self.family_marriage_year_posn = column
        self.family_marriage_year_column.add_attribute(
            self.family_marriage_year_cell, 'text', column)
        column = column + 1
        self.family_marriage_month_posn = column
        self.family_marriage_month_column.add_attribute(
            self.family_marriage_month_cell, 'text', column)
        column = column + 1
        self.family_marriage_day_posn = column
        self.family_marriage_day_column.add_attribute(
            self.family_marriage_day_cell, 'text', column)
        column = column + 1
        self.family_children_pointers_posn = column
        self.family_children_pointers_column.add_attribute(
            self.family_children_pointers_cell, 'text', column)
        self.family_last_posn = column

        # set the note cells "text" attribute to matching column - retrieve text
        # from that column in note treestore
        column = 0
        self.note_raw_gedcom_posn = column
        self.generic_raw_gedcom_posn = column
        self.note_raw_gedcom_column.add_attribute(
            self.note_raw_gedcom_cell, 'text', column)
        column = column + 1
        self.note_type_posn = column
        self.note_type_column.add_attribute(
            self.note_type_cell, 'text', column)
        self.note_type_cell.set_property('yalign', 0.0)
        column = column + 1
        self.note_pointer_posn = column
        self.generic_pointer_posn = column
        self.note_pointer_column.add_attribute(
            self.note_pointer_cell, 'text', column)
        self.note_pointer_cell.set_property('yalign', 0.0)
        column = column + 1
        self.note_text_posn = column
        self.generic_tag_posn = column
        self.note_text_column.add_attribute(
            self.note_text_cell, 'text', column)
        column = column + 1
        self.generic_values_posn = column

        # set the submitter cells "text" attribute to matching column - retrieve
        # text from that column in submitter treestore
        column = 0
        self.submitter_raw_gedcom_posn = column
        self.submitter_raw_gedcom_column.add_attribute(
            self.submitter_raw_gedcom_cell, 'text', column)
        column = column + 1
        self.submitter_type_posn = column
        self.submitter_type_column.add_attribute(
            self.submitter_type_cell, 'text', column)
        column = column + 1
        self.submitter_pointer_posn = column
        self.submitter_pointer_column.add_attribute(
            self.submitter_pointer_cell, 'text', column)
        column = column + 1
        self.submitter_name_posn = column
        self.submitter_name_column.add_attribute(
            self.submitter_name_cell, 'text', column)

        # set the repository cells "text" attribute to matching column - retrieve
        # text from that column in repository treestore
        column = 0
        self.repository_raw_gedcom_posn = column
        self.repository_raw_gedcom_column.add_attribute(
            self.repository_raw_gedcom_cell, 'text', column)
        column = column + 1
        self.repository_type_posn = column
        self.repository_type_column.add_attribute(
            self.repository_type_cell, 'text', column)
        column = column + 1
        self.repository_pointer_posn = column
        self.repository_pointer_column.add_attribute(
            self.repository_pointer_cell, 'text', column)
        column = column + 1
        self.repository_name_posn = column
        self.repository_name_column.add_attribute(
            self.repository_name_cell, 'text', column)

        # set the source cells "text" attribute to matching column - retrieve text
        # from that column in source treestore
        column = 0
        self.source_raw_gedcom_posn = column
        self.source_raw_gedcom_column.add_attribute(
            self.source_raw_gedcom_cell, 'text', column)
        column = column + 1
        self.source_type_posn = column
        self.source_type_column.add_attribute(
            self.source_type_cell, 'text', column)
        column = column + 1
        self.source_pointer_posn = column
        self.source_pointer_column.add_attribute(
            self.source_pointer_cell, 'text', column)
        column = column + 1
        self.source_abbreviation_posn = column
        self.source_abbreviation_column.add_attribute(
            self.source_abbreviation_cell, 'text', column)

        # set the object cells "text" attribute to matching column - retrieve text
        # from that column in object treestore
        column = 0
        self.object_raw_gedcom_posn = column
        self.object_raw_gedcom_column.add_attribute(
            self.object_raw_gedcom_cell, 'text', column)
        column = column + 1
        self.object_type_posn = column
        self.object_type_column.add_attribute(
            self.object_type_cell, 'text', column)
        column = column + 1
        self.object_pointer_posn = column
        self.object_pointer_column.add_attribute(
            self.object_pointer_cell, 'text', column)

        # set the submission cells "text" attribute to matching column - retrieve
        # text from that column in submission treestore
        column = 0
        self.submission_raw_gedcom_posn = column
        self.submission_raw_gedcom_column.add_attribute(
            self.submission_raw_gedcom_cell, 'text', column)
        column = column + 1
        self.submission_type_posn = column
        self.submission_type_column.add_attribute(
            self.submission_type_cell, 'text', column)
        column = column + 1
        self.submission_pointer_posn = column
        self.submission_pointer_column.add_attribute(
            self.submission_pointer_cell, 'text', column)

        # set the custom cells "text" attribute to matching column - retrieve text
        # from that column in custom treestore
        column = 0
        self.custom_raw_gedcom_posn = column
        self.custom_raw_gedcom_column.add_attribute(
            self.custom_raw_gedcom_cell, 'text', column)
        column = column + 1
        self.custom_type_posn = column
        self.custom_type_column.add_attribute(
            self.custom_type_cell, 'text', column)
        column = column + 1
        self.custom_pointer_posn = column
        self.custom_pointer_column.add_attribute(
            self.custom_pointer_cell, 'text', column)
        ...
        actiongroup.add_actions([('Open Gedcom', gtk.STOCK_OPEN, '_Open GEDCOM...', None, None, self.open_gedcom),
                                 ('Save Gedcom', gtk.STOCK_SAVE,
                                  '_Save GEDCOM...', None, None, self.save_gedcom),
        ...
        actiongroup.add_actions([('Add Individual', None, 'Add _Individual', '<Control>i', None, self.add_individual),
                                 ('Add Spouse', None, 'Add S_pouse',
                                  '<Control>p', None, self.add_spouse),
                                 ('Add Child', None, 'Add _Child',
                                  '<Control>c', None, self.add_child),
                                 ('Add Father', None, 'Add _Father',
                                  None, None, self.add_father),
                                 ('Add Mother', None, 'Add _Mother',
                                  None, None, self.add_mother),
                                 ('Add Family', None, 'Add _Family',
                                  '<Control>f', None, self.add_family),
                                 ('Add Note', None, 'Add _Note',
                                  '<Control>n', None, self.add_note),
                                 ('Delete Individual', None, 'Delete Individual',
                                  None, None, self.delete_individual),
                                 ('Delete Family', None, 'Delete Family', None, None, self.delete_family)])

        actiongroup.add_actions(
            [('Refresh', None, '_Refresh', '<Control>r', None, self.refresh_view)])

        actiongroup.add_actions([('Readme', gtk.STOCK_HELP, '_Readme', None, None, self.show_help),
                                 ('License', gtk.STOCK_HELP, '_License',
                                  None, None, self.show_license),
                                 ('Tag List', gtk.STOCK_HELP, '_Tag List',
                                  None, None, self.show_valid_tags),
        ...
        actiongroup.add_toggle_actions([('Siblings', None, 'Siblings Include', None, '', self.siblings_dot_toggle, False),
                                        ('Spouses', None, 'Spouses Include', None,
                                         '', self.spouses_dot_toggle, False),
        ...
        actiongroup.add_actions([('Set Dot Graph Title', None, 'Set Dot Graph Title...', None, None, self.set_dot_graph_title),
                                 ('Set Dot Graph Depth', None, 'Set Dot Graph Depth...',
                                  None, None, self.set_dot_graph_depth),
                                 ('Generate Dot Graph', None, 'Generate Dot Graph...',
                                  None, None, self.save_dot_graph),
        ...
        actiongroup.add_radio_actions([('PNG', None, 'P_NG', None, None, 0),
                                       ...
                                       ], 0, self.dot_convert_type_cb)

        actiongroup.add_actions(
            [('Convert Dot Graph', gtk.STOCK_OPEN, '_Open Dot...', None, None, self.convert_dot_graph)])

        actiongroup.add_actions(
            [('Last Name Frequency', None, '_Last Name Frequency...', None, None, self.last_name_frequency_report)])
    ...
    def individual_delete_cb(self, cell, path, model):
        model[path][self.individual_delete_posn] = not model[
            path][self.individual_delete_posn]
    ...
    def raw_gedcom_delete_cb(self, cell, path, raw_gedcom_treestore, input_treestore, input_iter):
        raw_gedcom_treestore[path][self.raw_gedcom_delete_posn] = not raw_gedcom_treestore[
            path][self.raw_gedcom_delete_posn]
    ...
    def family_cursor_changed(self, treeview):
        ...
        if colname in ("Husband\nGiven\nNames", "Husband\nLast\nName"):
            family_husband_pointer = model.get_value(
                iter, self.family_husband_pointer_posn)
            if family_husband_pointer:
                self.set_cursor(
                    family_husband_pointer, self.individual_treeview)
        if colname in ("Wife\nGiven\nNames", "Wife\nLast\nName"):
            family_wife_pointer = model.get_value(
                iter, self.family_wife_pointer_posn)
    ...
    def list_individual(self, treeview):
        ...
        while self.generic_iter:
            self.temp_individual_pointer = self.individual_treestore.get_value(
                self.generic_iter, self.individual_pointer_posn)
            self.temp_individual_given_names = self.individual_treestore.get_value(
                self.generic_iter, self.individual_given_names_posn)
            self.temp_individual_last_name = self.individual_treestore.get_value(
                self.generic_iter, self.individual_last_name_posn)
            self.temp_individual_sex = self.individual_treestore.get_value(
                self.generic_iter, self.individual_sex_posn)
            self.temp_individual_birth_date = self.individual_treestore.get_value(
                self.generic_iter, self.individual_birth_date_posn)
            self.temp_individual_death_date = self.individual_treestore.get_value(
                self.generic_iter, self.individual_death_date_posn)
            ...
            if self.temp_individual_sex == "M":
                individual = self.temp_individual_pointer.split("@")[1] + ' [label="' + self.temp_individual_given_names + ' ' + self.temp_individual_last_name + \
                    ...
                    self.temp_individual_death_date + \
                    '",color=lightblue]' + '\n'
            else:
                individual = self.temp_individual_pointer.split("@")[1] + ' [label="' + self.temp_individual_given_names + ' ' + self.temp_individual_last_name + \
                    '\\n' + 'B: ' + self.temp_individual_birth_date + '\\n' + 'D: ' + \
    ...
    def find_individual(self, pointer, treeview):
        ...
        self.generic_path = model.get_path(self.generic_iter)
        while self.generic_iter:
            self.temp_individual_pointer = model.get_value(
                self.generic_iter, self.generic_pointer_posn)
            if self.temp_individual_pointer == pointer:
                self.temp_individual_pointer = self.individual_treestore.get_value(
                    self.generic_iter, self.individual_pointer_posn)
                self.temp_individual_raw_gedcom = self.individual_treestore.get_value(
                    self.generic_iter, self.individual_raw_gedcom_posn)
                self.temp_individual_given_names = self.individual_treestore.get_value(
                    self.generic_iter, self.individual_given_names_posn)
                self.temp_individual_last_name = self.individual_treestore.get_value(
                    self.generic_iter, self.individual_last_name_posn)
                ...
                self.temp_individual_birth_date = self.individual_treestore.get_value(
                    self.generic_iter, self.individual_birth_date_posn)
                self.temp_individual_birth_year = self.individual_treestore.get_value(
                    self.generic_iter, self.individual_birth_year_posn)
                self.temp_individual_birth_month = self.individual_treestore.get_value(
                    self.generic_iter, self.individual_birth_month_posn)
                self.temp_individual_birth_day = self.individual_treestore.get_value(
                    self.generic_iter, self.individual_birth_day_posn)
                self.temp_individual_death_date = self.individual_treestore.get_value(
                    self.generic_iter, self.individual_death_date_posn)
                self.temp_individual_death_year = self.individual_treestore.get_value(
                    self.generic_iter, self.individual_death_year_posn)
                self.temp_individual_death_month = self.individual_treestore.get_value(
                    self.generic_iter, self.individual_death_month_posn)
                self.temp_individual_death_day = self.individual_treestore.get_value(
                    self.generic_iter, self.individual_death_day_posn)
                self.temp_individual_family_pointers = self.individual_treestore.get_value(
                    self.generic_iter, self.individual_family_pointers_posn)
                self.temp_individual_parent_pointers = self.individual_treestore.get_value(
                    self.generic_iter, self.individual_parent_pointers_posn)
                return
            else:
                self.generic_iter = model.iter_next(self.generic_iter)
                self.generic_path = model.get_path(self.generic_iter)
    ...
    def list_family(self, treeview):
        ...
        self.generic_path = model.get_path(self.generic_iter)
        while self.generic_iter:
            self.temp_family_pointer = model.get_value(
                self.generic_iter, self.generic_pointer_posn)
            self.temp_family_husband_pointer = model.get_value(
                self.generic_iter, self.family_husband_pointer_posn)
            self.temp_family_husband_given_names = model.get_value(
                self.generic_iter, self.family_husband_given_names_posn)
            self.temp_family_husband_last_name = model.get_value(
                self.generic_iter, self.family_husband_last_name_posn)
            self.temp_family_wife_pointer = model.get_value(
                self.generic_iter, self.family_wife_pointer_posn)
            self.temp_family_wife_given_names = model.get_value(
                self.generic_iter, self.family_wife_given_names_posn)
            self.temp_family_wife_last_name = model.get_value(
                self.generic_iter, self.family_wife_last_name_posn)
            self.temp_family_children_pointers = model.get_value(
                self.generic_iter, self.family_children_pointers_posn)
            self.temp_family_marriage_date = model.get_value(
                self.generic_iter, self.family_marriage_date_posn)

            family = self.temp_family_pointer.split(
                "@")[1] + ' [shape=box, ranksep=0.1, orientation=270.0, label="' + 'M: ' + self.temp_family_marriage_date + '", color=palegreen]' + '\n'
            self.dot_file.write(family)

            if self.temp_family_husband_pointer:
                family_link = self.temp_family_husband_pointer.split(
                    "@")[1] + " -> " + self.temp_family_pointer.split("@")[1] + " [weight=10]" + "\n"
                self.dot_file.write(family_link)

            if self.temp_family_wife_pointer:
                family_link = self.temp_family_wife_pointer.split(
                    "@")[1] + " -> " + self.temp_family_pointer.split("@")[1] + " [weight=10]" + "\n"
                self.dot_file.write(family_link)
            ...
            family_children_pointers = string.split(
                self.temp_family_children_pointers, ",")
                ...
                for j in family_children_pointers:
                    ...
                    if prev_j:
                        child_arrow = child_arrow + \
                            prev_j.split("@")[1] + " -> " + j.split("@")[1] + \
                            " [style=invis]" + "\n"
                    prev_j = j
                child_joins = "{" + "\n"
                child_joins = child_joins + \
                    "rank=same; ordering=out; " + child_list + "\n"
            ...
            for c in family_children_pointers:
                if c:
                    child_link = self.temp_family_pointer.split(
                        "@")[1] + " -> " + c.split("@")[1] + "\n"
    ...
    def find_family(self, pointer, treeview):
        ...
        while self.generic_iter:
            ...
            if self.temp_family_pointer == pointer:
                self.temp_family_raw_gedcom = model.get_value(
                    self.generic_iter, self.family_raw_gedcom_posn)
                self.temp_family_husband_pointer = model.get_value(
                    self.generic_iter, self.family_husband_pointer_posn)
                self.temp_family_husband_given_names = model.get_value(
                    self.generic_iter, self.family_husband_given_names_posn)
    ...
    def set_cursor(self, pointer, treeview):
        ...
        while self.generic_iter:
            ...
            if val == pointer:
                ...
                treeview.set_cursor(
                    self.generic_path, focus_column=treeview.get_column(3))
    ...
    def save_gedcom(self, action):
        ...
        file_save = gtk.FileChooserDialog(title="Save GEDCOM File", action=gtk.FILE_CHOOSER_ACTION_SAVE, buttons=(
        ...
        self.on_show_note(
            self.window, "NOTE: GEDOM save (in " + self.unicode_type + " format) proceeding to " + file_name, "OK")
        ...
        if self.unicode_type == "utf-16-le":
            # reverse from proper since it will be reversed on write
            file.write(u'\ufeff')
        ...
        gedcom_dir = os.path.dirname(file_name)+"/"
        write_ini_data(self.window, 'Report', 'gedcom_dir', gedcom_dir)
    ...
    def open_gedcom(self, action):
        ...
        file_open = gtk.FileChooserDialog(title="Select GEDCOM File", action=gtk.FILE_CHOOSER_ACTION_OPEN, buttons=(
        ...
        if file_name:
            ...
            for e in g.element_list():
                if e.tag() == "FAM":
                    ...
                    self.family_dict[e.pointer()] = (
                        husband, wife, [date, place], children, e.get_individual())
            ...
            for e in g.element_list():
                if e.individual():
                    ...
                    self.individual_dict[e.pointer()] = (
                        e.name(), sex, e.birth(), e.death(), family, parents, e.get_individual())
            ...
            for p in pd:
                ...
                piter = self.individual_treestore.append(None, [self.individual_raw_gedcom, "INDIVIDUAL", p, self.individual_given_names, self.individual_last_name, self.individual_sex, self.individual_birth_date, self.individual_birth_year,
                                                                self.individual_birth_month, self.individual_birth_day, self.individual_death_date, self.individual_death_year, self.individual_death_month, self.individual_death_day, self.individual_family_pointers, self.individual_parent_pointers])
            ...
            for f in fd:
                ...
                piter = self.family_treestore.append(None, [self.family_raw_gedcom, "FAMILY", f, self.family_husband_pointer, self.family_husband_given_names, self.family_husband_last_name, self.family_wife_pointer,
            ...
            for n in nd:
                ...
                for raw_gedcom_line in self.note_raw_gedcom.split("\n"):
                    ...
                    if int(level) == 1 and tag == "CONT":
                        notes = notes + "\n" + values
                piter = self.note_treestore.append(
                    None, [self.note_raw_gedcom, "NOTE", n, notes])
            ...
            for s in sd:
                ...
                for raw_gedcom_line in self.submitter_raw_gedcom.split("\n"):
                    ...
                    if int(level) == 1 and tag == "NAME":
                        name = name + values
                piter = self.submitter_treestore.append(
                    None, [self.submitter_raw_gedcom, "SUBMITTER", s, name])
            ...
            for r in rd:
                ...
                for raw_gedcom_line in self.repository_raw_gedcom.split("\n"):
                    ...
                    if int(level) == 1 and tag == "NAME":
                        name = name + values
                piter = self.repository_treestore.append(
                    None, [self.repository_raw_gedcom, "REPOSITORY", r, name])
            ...
            for sr in srd:
                ...
                piter = self.source_treestore.append(
                    None, [self.source_raw_gedcom, "SOURCE", sr, abbrev])
            ...
            for o in od:
                ...
                piter = self.object_treestore.append(
                    None, [self.object_raw_gedcom, "OBJECT", o])
            ...
            for sn in snd:
                ...
                piter = self.submission_treestore.append(
                    None, [self.submission_raw_gedcom, "SUBMISSION", sn])
            ...
            for m in md:
                ...
                piter = self.custom_treestore.append(
                    None, [self.custom_raw_gedcom, "CUSTOM", m])
    ...
    def convert_dot_graph(self, type):
        ...
        file_open = gtk.FileChooserDialog(title="Select Dot File", action=gtk.FILE_CHOOSER_ACTION_OPEN, buttons=(
            gtk.STOCK_CANCEL, gtk.RESPONSE_CANCEL, gtk.STOCK_OPEN, gtk.RESPONSE_OK))
        ...
        convert_name = file_name.split(
            '.dot')[0] + '.' + dot_convert_type.lower()

        os.system('/usr/bin/dot -T' + dot_convert_type.lower() +
                  ' -o ' + convert_name + ' ' + file_name)

        self.on_show_note(self.window, "Dot file " + file_name + " successfully converted into " +
                          string.upper(dot_convert_type) + ' at ' + convert_name, "OK")
    ...
    def open_dot_graph(self, action):
        ...
        if file_open.run() == gtk.RESPONSE_OK:
            file_name = file_open.get_filename()
            dot_dir = os.path.dirname(file_name)+"/"
            write_ini_data(self.window, 'Report', 'dot_dir', dot_dir)
    ...
    def set_dot_graph_depth(self, action):
        ...
        adjustment = gtk.Adjustment(
            value=traverse_level_max, lower=0, upper=99, step_incr=1, page_incr=1)
    ...
    def save_dot_graph(self, action):
        ...
        individual_model, individual_iter = self.individual_treeview.get_selection(
            ).get_selected()
        if not individual_iter:
            self.on_show_note(
                self.window, "ERROR: Must select individual to generate parent DOT graph for!", "OK")
            return

        pointer = self.individual_treestore.get_value(
            individual_iter, self.individual_pointer_posn)
        ...
        file_save = gtk.FileChooserDialog(title="Save Parent DOT File", action=gtk.FILE_CHOOSER_ACTION_SAVE, buttons=(
            gtk.STOCK_CANCEL, gtk.RESPONSE_CANCEL, gtk.STOCK_SAVE, gtk.RESPONSE_OK))
        ...
        if everyone_dot_flag:
            ...
            if parents_dot_flag:
                ...
                self.dot_file.write(head)
                self.traverse_parents(
                    pointer, living_dates_flag, siblings_dot_flag, spouses_dot_flag, children_dot_flag)
                self.on_show_note(
                    self.window, "Dot file successfully generated for parents of " + pointer, "OK")
            ...
            if children_dot_flag:
                ...
                self.traverse_children(
                    pointer, living_dates_flag, spouses_dot_flag, direction_flag=1)
                self.on_show_note(
                    self.window, "Dot file successfully generated for children of " + pointer, "OK")
    ...
    def traverse_children(self, individual_pointer, living_dates_flag, spouses_dot_flag, direction_flag=None):
        ...
        if living_dates_flag == False and (self.temp_individual_death_date == "" and (self.temp_individual_birth_year != "" and datetime.date.today().year - int(self.temp_individual_birth_year) < 100)):
            if self.temp_individual_sex == "M":
                individual = individual_pointer.split(
                    "@")[1] + ' [label="' + self.temp_individual_given_names + ' ' + self.temp_individual_last_name + '\\n' + '",color=lightblue]' + '\n'
            else:
                individual = individual_pointer.split(
                    "@")[1] + ' [label="' + self.temp_individual_given_names + ' ' + self.temp_individual_last_name + '\\n' + '",color=lightpink]' + '\n'
        else:
        ...
        individual_family_pointers = string.split(
            self.temp_individual_family_pointers, ",")
            ...
            if f:
                ...
                if (spouses_dot_flag == True) or (spouses_dot_flag == False and self.traverse_level < traverse_level_max):
                    ...
                    if direction_flag is None:
                        family_link = individual_pointer.split(
                            "@")[1] + " -> " + self.temp_family_pointer.split("@")[1] + " [weight=10]" + "\n"
                    else:
                        family_link = self.temp_family_pointer.split(
                            "@")[1] + " -> " + individual_pointer.split("@")[1] + " [weight=10]" + "\n"
                    self.dot_file.write(family_link)
                    if individual_sex == "M":
                        # if self.temp_individual_sex == "M":
                        if self.temp_family_wife_pointer:
                            self.find_individual(
                                self.temp_family_wife_pointer, self.individual_treeview)
                            if living_dates_flag == False and (self.temp_individual_death_date == "" and (self.temp_individual_birth_year != "" and datetime.date.today().year - int(self.temp_individual_birth_year) < 100)):
                                individual = self.temp_individual_pointer.split(
                                    "@")[1] + ' [label="' + self.temp_individual_given_names + ' ' + self.temp_individual_last_name + '\\n' + '",color=lightpink]' + '\n'
                            else:
                                individual = self.temp_individual_pointer.split(
                            ...
                            if direction_flag is None:
                                ...
                                family_link = self.temp_family_pointer.split(
                                    "@")[1] + " -> " + self.temp_family_wife_pointer.split("@")[1] + " [weight=10]" + "\n"
                            self.dot_file.write(family_link)
                        ...
                        if self.temp_family_husband_pointer:
                            self.find_individual(
                                self.temp_family_husband_pointer, self.individual_treeview)
                            if living_dates_flag == False and (self.temp_individual_death_date == "" and (self.temp_individual_birth_year != "" and datetime.date.today().year - int(self.temp_individual_birth_year) < 100)):
                                individual = self.temp_individual_pointer.split(
                                    "@")[1] + ' [label="' + self.temp_individual_given_names + ' ' + self.temp_individual_last_name + '\\n' + '",color=lightblue]' + '\n'
                            else:
                            ...
                            if direction_flag is None:
                                ...
                                family_link = self.temp_family_pointer.split(
                                    "@")[1] + " -> " + self.temp_family_husband_pointer.split("@")[1] + " [weight=10]" + "\n"
                            self.dot_file.write(family_link)
                ...
                for c in family_children_pointers:
                    if c:
                        ...
                        if self.traverse_level <= traverse_level_max:
                            self.dot_file.write(child_link)
                            self.traverse_children(
                                c, living_dates_flag, spouses_dot_flag, direction_flag)
                        self.traverse_level -= 1
    ...
    def traverse_parents(self, individual_pointer, living_dates_flag, siblings_flag=None, spouses_dot_flag=False, children_dot_flag=False, direction_flag=None):
            ...
            for f in individual_family_pointers:
                if self.family_dict.has_key(f):
                    ...
                    if self.temp_family_wife_pointer and individual_pointer != self.temp_family_wife_pointer:
                        ...
                        self.traverse_parents(
                            spouse_pointer, living_dates_flag, siblings_flag, spouses_dot_flag)
        ...
        individual_parent_pointers = string.split(
            self.temp_individual_parent_pointers, ",")
            ...
            if self.family_dict.has_key(p):
                ...
                if siblings_flag == True:
                    ...
                    for c in family_children_pointers:
                        ...
                        if c and (c != individual_pointer):
                            ...
                            if living_dates_flag == False and (self.temp_individual_death_date == "" and (self.temp_individual_birth_year != "" and datetime.date.today().year - int(self.temp_individual_birth_year) < 100)):
                                if self.temp_individual_sex == "M":
                                    individual = sibling_pointer.split(
                                        "@")[1] + ' [label="' + self.temp_individual_given_names + ' ' + self.temp_individual_last_name + '\\n' + '",color=lightblue]' + '\n'
                                else:
                                    individual = sibling_pointer.split(
                                        "@")[1] + ' [label="' + self.temp_individual_given_names + ' ' + self.temp_individual_last_name + '\\n' + '",color=lightpink]' + '\n'
                ...
                if father_pointer:
                    if not self.parent_hit.has_key(father_pointer):
                        ...
                        if direction_flag is None:
                            father_link = p.split(
                                "@")[1] + " -> " + father_pointer.split("@")[1] + "\n"
                        else:
                            father_link = father_pointer.split(
                                "@")[1] + " -> " + p.split("@")[1] + "\n"
                        self.dot_file.write(father_link)
                        self.traverse_parents(
                            father_pointer, living_dates_flag, siblings_flag, spouses_dot_flag)
                        self.traverse_level -= 1
                if mother_pointer:
                    if not self.parent_hit.has_key(mother_pointer):
                        ...
                        if direction_flag is None:
                            mother_link = p.split(
                                "@")[1] + " -> " + mother_pointer.split("@")[1] + "\n"
                        else:
                            mother_link = mother_pointer.split(
                                "@")[1] + " -> " + p.split("@")[1] + "\n"
                        self.dot_file.write(mother_link)
                        self.traverse_parents(
                            mother_pointer, living_dates_flag, siblings_flag, spouses_dot_flag)
                        self.traverse_level -= 1

        return

    def get_next_individual_pointer(self):
        self.next_individual_pointer_number = self.next_individual_pointer_number + \
            1
        self.next_individual_pointer = "@I" + \
            str(self.next_individual_pointer_number).zfill(4) + "@"
    ...
    def get_next_family_pointer(self):
        ...
        self.next_family_pointer = "@F" + \
            str(self.next_family_pointer_number).zfill(4) + "@"
        while self.family_dict.has_key(self.next_family_pointer):
            self.next_family_pointer_number = self.next_family_pointer_number + \
                1
            self.next_family_pointer = "@F" + \
                str(self.next_family_pointer_number).zfill(4) + "@"
    ...
    def get_next_note_pointer(self):
        ...
        self.next_note_pointer = "@N" + \
            str(self.next_note_pointer_number).zfill(4) + "@"
    ...
    def gedcom_direction_cb(self, action, current):
        ...
        self.new_individual_treestore = gtk.TreeStore(
            str, str, str, str, str, str, str, str, str, str, str, str, str, str, str, str)
        ...
        for row in self.new_individual_treestore:
            ...
            self.individual_family_pointers = row[
                self.individual_family_pointers_posn]
            if relation_style == "ParentChild":
                # if len(self.individual_family_pointers) > 0:
                if self.individual_family_pointers:
                    self.individual_treestore.append(piter)

            self.individual_parent_pointers = row[
                self.individual_parent_pointers_posn]
            if relation_style == "ChildParent":
                # if len(self.individual_parent_pointers) > 0:
                if self.individual_parent_pointers:
                    self.individual_treestore.append(piter)
    ...
    def dot_convert_type_cb(self, action, current):
    ...
    def refresh_view(self, widget):
        ...
        self.new_family_treestore = gtk.TreeStore(
            str, str, str, str, str, str, str, str, str, str, str, str, str, str)
    ...
    def show_text_file(self, file_name):
        ...
        textview.modify_font(
            pango.FontDescription('Courier bold ' + str(font_size)))
    ...
    def show_valid_tags(self, widget):
        ...
        for tag in vt:
            out_string = out_string + \
                string.ljust(tag, 4) + " : " + self.valid_tags[tag] + "\n"
    ...
    def last_name_frequency_report(self, widget):
        ...
        for count in sort_freq:
            last_name_frequency_iter = last_name_frequency_treestore.append(
                None, [count[0], count[1]])

        # create the TreeView using treestore
        last_name_frequency_treeview = gtk.TreeView(
            last_name_frequency_treestore)
        last_name_frequency_treeview.set_headers_visible(
            True)		# needed for Maemo
        ...
        last_name_column = gtk.TreeViewColumn(
            'Last Name', last_name_cell, text=0)
        self.set_column_style(last_name_column)
        frequency_column = gtk.TreeViewColumn(
            'Frequency', frequency_cell, text=1)
        ...
        # set the cell "text" attribute to column 0 - retrieve text from that
        # column in treestore
        column = 0
    ...
    def individual_on_row_expanded(self, store, iter, path):
        ...
        if store.get_value(child, 0) is None:
            ...
            individual_pointer = store.get_value(
                iter, self.individual_pointer_posn)
            if relation_style == "ParentChild":
                if not self.individual_dict.has_key(individual_pointer):
                    ...
                    individual_family_pointers = string.split(
                        store.get_value(iter, self.individual_family_pointers_posn), ",")
                    for f in individual_family_pointers:
                        if self.family_dict.has_key(f):
                            self.find_family(f, self.family_treeview)
                            ...
                            if individual_pointer == husband_pointer:
                                store.set_value(
                                    iter, self.generic_type_posn, "HUSBAND")
                                w = wife_pointer
                                if w:
                                    self.find_individual(
                                        w, self.individual_treeview)
                                    piter = self.individual_treestore.append(iter, [self.temp_individual_raw_gedcom, "WIFE", w, self.temp_individual_given_names, self.temp_individual_last_name, self.temp_individual_sex, self.temp_individual_birth_date, self.temp_individual_birth_year,
                                                                                    self.temp_individual_birth_month, self.temp_individual_birth_day, self.temp_individual_death_date, self.temp_individual_death_year, self.temp_individual_death_month, self.temp_individual_death_day, self.temp_individual_family_pointers, self.temp_individual_parent_pointers])
                                    family_children_pointers = string.split(
                                        self.temp_family_children_pointers, ",")
                                    for c in family_children_pointers:
                                        if self.individual_dict.has_key(c):
                                            self.find_individual(
                                                c, self.individual_treeview)
                                            citer = self.individual_treestore.append(piter, [self.temp_individual_raw_gedcom, "CHILD", c, self.temp_individual_given_names, self.temp_individual_last_name, self.temp_individual_sex, self.temp_individual_birth_date, self.temp_individual_birth_year,
                                                                                             self.temp_individual_birth_month, self.temp_individual_birth_day, self.temp_individual_death_date, self.temp_individual_death_year, self.temp_individual_death_month, self.temp_individual_death_day, self.temp_individual_family_pointers, self.temp_individual_parent_pointers])
                                            if self.individual_family_pointers:
                                                self.individual_treestore.append(
                                                    citer)
                                else:
                            ...
                            if individual_pointer == wife_pointer:
                                store.set_value(
                                    iter, self.generic_type_posn, "WIFE")
                                h = husband_pointer
                                if h:
                                    self.find_individual(
                                        h, self.individual_treeview)
                                    piter = self.individual_treestore.append(iter, [self.temp_individual_raw_gedcom, "HUSBAND", h, self.temp_individual_given_names, self.temp_individual_last_name, self.temp_individual_sex, self.temp_individual_birth_date, self.temp_individual_birth_year,
                                                                                    self.temp_individual_birth_month, self.temp_individual_birth_day, self.temp_individual_death_date, self.temp_individual_death_year, self.temp_individual_death_month, self.temp_individual_death_day, self.temp_individual_family_pointers, self.temp_individual_parent_pointers])
                                    family_children_pointers = string.split(
                                        self.temp_family_children_pointers, ",")
                                    for c in family_children_pointers:
            ...
            if relation_style == "ChildParent":
                if not self.individual_dict.has_key(individual_pointer):
                    ...
                    individual_parent_pointers = string.split(
                        store.get_value(iter, self.individual_parent_pointers_posn), ",")[0]
                    if self.family_dict.has_key(individual_parent_pointers):
                        self.find_family(
                            individual_parent_pointers, self.family_treeview)
                        f = self.temp_family_husband_pointer
                        m = self.temp_family_wife_pointer
                        if f:
                            self.find_individual(f, self.individual_treeview)
                            piter = self.individual_treestore.append(iter, [self.temp_individual_raw_gedcom, "FATHER", f, self.temp_individual_given_names, self.temp_individual_last_name, self.temp_individual_sex, self.temp_individual_birth_date, self.temp_individual_birth_year,
                                                                            self.temp_individual_birth_month, self.temp_individual_birth_day, self.temp_individual_death_date, self.temp_individual_death_year, self.temp_individual_death_month, self.temp_individual_death_day, self.temp_individual_family_pointers, self.temp_individual_parent_pointers])
                            if self.temp_individual_parent_pointers:
                                self.individual_treestore.append(piter)
                        if m:
                            self.find_individual(m, self.individual_treeview)
                            piter = self.individual_treestore.append(iter, [self.temp_individual_raw_gedcom, "MOTHER", m, self.temp_individual_given_names, self.temp_individual_last_name, self.temp_individual_sex, self.temp_individual_birth_date, self.temp_individual_birth_year,
                                                                            self.temp_individual_birth_month, self.temp_individual_birth_day, self.temp_individual_death_date, self.temp_individual_death_year, self.temp_individual_death_month, self.temp_individual_death_day, self.temp_individual_family_pointers, self.temp_individual_parent_pointers])
                            if self.temp_individual_parent_pointers:
                                self.individual_treestore.append(piter)
    ...
    def get_individual_info(self, individual_pointer):
        if not self.individual_dict.has_key(individual_pointer):
            print "ERROR: individual pointer does NOT exist in GEDCOM file!", individual_pointer
            return
        self.individual_given_names = self.individual_dict[
            individual_pointer][0][0]
        self.individual_last_name = self.individual_dict[
            individual_pointer][0][1]
        self.individual_sex = self.individual_dict[individual_pointer][1]
        self.individual_birth_date = self.individual_dict[
            individual_pointer][2][0].lstrip()
        self.individual_birth_place = self.individual_dict[
            individual_pointer][2][1]
        self.individual_death_date = self.individual_dict[
            individual_pointer][3][0].lstrip()
        self.individual_death_place = self.individual_dict[
            individual_pointer][3][1]
        ...
        for x in ifp:
            self.individual_family_pointers = self.individual_family_pointers + \
                x + ","
        if self.individual_family_pointers and self.individual_family_pointers[-1] == ",":
            self.individual_family_pointers = self.individual_family_pointers[
                :-1]
        self.individual_parent_pointers = self.individual_dict[
            individual_pointer][5]
        if self.individual_parent_pointers:
        ...
        self.individual_raw_gedcom = self.individual_dict[
            individual_pointer][6]
    ...
    def get_family_info(self, family_pointer):
        ...
        if self.individual_dict.has_key(self.family_husband_pointer):
            self.family_husband_given_names = self.individual_dict[
                self.family_husband_pointer][0][0]
            self.family_husband_last_name = self.individual_dict[
                self.family_husband_pointer][0][1]
        ...
        if self.individual_dict.has_key(self.family_wife_pointer):
            ...
            self.family_wife_given_names = self.individual_dict[
                self.family_wife_pointer][0][0]
            self.family_wife_last_name = self.individual_dict[
                self.family_wife_pointer][0][1]
        self.family_marriage_date = self.family_dict[
            family_pointer][2][0].lstrip()
        ...
        for x in fcp:
            self.family_children_pointers = self.family_children_pointers + \
                x + ","
    ...
    def add_child(self, widget):
        ...
        individual_treestore,  individual_iter = self.individual_treeview.get_selection(
            ).get_selected()

        individual_pointer = individual_treestore.get_value(
            individual_iter, self.individual_pointer_posn)

        prev_individual_iter = individual_treestore.iter_parent(
            individual_iter)
        if prev_individual_iter:
            type = individual_treestore.get_value(
                prev_individual_iter, self.individual_type_posn)
            prev_individual_pointer = individual_treestore.get_value(
                prev_individual_iter, self.individual_pointer_posn)
            if type not in ("HUSBAND", "WIFE", "NEWHUSBAND", "NEWWIFE"):
                print "ERROR: Not positioned on proper parent row for new child!"
                self.on_show_note(
                    self.window, "ERROR: Not positioned on proper parent row!\n" + individual_pointer, "OK")
                return
        else:
            print "ERROR: Not positioned on proper parent row for new child!"
            self.on_show_note(
        ...
        fp = individual_treestore.get_value(
            individual_iter, self.individual_family_pointers_posn)
        if not fp:
            print "No family to attach child too!"
            self.on_show_note(
                self.window, "ERROR: family pointer does NOT exist in GEDCOM file!\n" + fp, "OK")
            return

        individual_family_pointers = string.split(
            individual_treestore.get_value(individual_iter, self.individual_family_pointers_posn), ",")
        ...
        if self.family_dict.has_key(individual_family_pointers):
            ...
            raw_gedcom = self.family_treestore.get_value(
                self.generic_iter, self.generic_raw_gedcom_posn)
            new_raw_gedcom = raw_gedcom + "\n" + \
                "1 CHIL " + self.next_individual_pointer
            self.family_treestore.set_value(
                self.generic_iter, self.generic_raw_gedcom_posn, new_raw_gedcom)
            new_children_pointers = self.family_treestore.get_value(
                self.generic_iter, self.family_children_pointers_posn)
            new_children_pointers = new_children_pointers + \
                "," + self.next_individual_pointer
            self.family_treestore.set_value(
                self.generic_iter, self.family_children_pointers_posn, new_children_pointers)
        else:
            print "No family to attach child too!"
            self.on_show_note(
                self.window, "ERROR: family pointer does NOT exist in GEDCOM file!\n" + individual_pointer, "OK")
        ...
        raw_gedcom_iter = raw_gedcom_treestore.append(
            None, ["0", self.next_individual_pointer, "INDI", ""])
        raw_gedcom_iter = raw_gedcom_treestore.append(
            None, ["1", " ", "NAME", "GivenNames /Lastname/"])
        raw_gedcom_iter = raw_gedcom_treestore.append(
            None, ["1", " ", "SEX", "M or F"])
        raw_gedcom_iter = raw_gedcom_treestore.append(
            None, ["1", " ", "BIRT", ""])
        raw_gedcom_iter = raw_gedcom_treestore.append(
            None, ["2", " ", "DATE", "dd Mmm yyyy"])
        raw_gedcom_iter = raw_gedcom_treestore.append(
            None, ["2", " ", "PLAC", "location"])
        raw_gedcom_iter = raw_gedcom_treestore.append(
            None, ["1", " ", "DEAT", ""])
        raw_gedcom_iter = raw_gedcom_treestore.append(
            None, ["2", " ", "DATE", "dd Mmm yyyy"])
        raw_gedcom_iter = raw_gedcom_treestore.append(
            None, ["2", " ", "PLAC", "location"])
        raw_gedcom_iter = raw_gedcom_treestore.append(
            None, ["1", " ", "FAMC", individual_family_pointers])
        raw_gedcom_iter = raw_gedcom_treestore.append(
            None, ["1", " ", "FAMS", "@Fnnnn@"])
        raw_gedcom_iter = raw_gedcom_treestore.append(
            None, ["1", " ", "NOTE", "@Nnnnn@"])

        # dare, beware that you are adding a child as a new person -- not one that
        # might already have his own info/relationships

        new_child_iter = self.individual_treestore.insert_after(individual_iter, None, [
                                                                "", "NEWCHILD", self.next_individual_pointer, "GivenNames", "LastName", "Sex", "BirthDate", "BirthYear", "BirthMonth", "BirthDay", "DeathDate", "DeathYear", "DeathMonth", "DeathDay", "", individual_family_pointers])

        new_individual_iter = self.individual_treestore.insert_after(
            None, None, ["", "NEWINDIVIDUAL", self.next_individual_pointer, "GivenNames", "LastName", "Sex", "BirthDate", "BirthYear", "BirthMonth", "BirthDay", "DeathDate", "DeathYear", "DeathMonth", "DeathDay", "", individual_family_pointers])

        self.save_raw_gedcom(
            raw_gedcom_treestore, self.individual_treestore, new_child_iter)

        raw_gedcom_treeview = self.raw_gedcom_edit(
            raw_gedcom_treestore, self.individual_treestore, new_child_iter, window)

        self.individual_treestore.set_value(
            new_child_iter, self.individual_parent_pointers_posn, individual_family_pointers)
        ...
        while iter:
            if func(model, iter, data):
                if model == self.individual_treestore:
                    ...
                    #result = model.remove(iter)
            result = self.treerow_search_and_delete(
    ...
    def treerow_search_and_copy(self, model, iter, func, data):
        while iter:
            if func(model, iter, data):
                if model == self.individual_treestore:
                    self.individual_treestore.set_value(
                        iter, self.individual_raw_gedcom_posn, self.temp_individual_raw_gedcom)
                    self.individual_treestore.set_value(
                        iter, self.individual_given_names_posn, self.temp_individual_given_names)
                    self.individual_treestore.set_value(
                        iter, self.individual_last_name_posn, self.temp_individual_last_name)
                    self.individual_treestore.set_value(
                        iter, self.individual_sex_posn, self.temp_individual_sex)
                    self.individual_treestore.set_value(
                        iter, self.individual_birth_date_posn, self.temp_individual_birth_date)
                    self.individual_treestore.set_value(
                        iter, self.individual_birth_year_posn, self.temp_individual_birth_year)
                    self.individual_treestore.set_value(
                        iter, self.individual_birth_month_posn, self.temp_individual_birth_month)
                    self.individual_treestore.set_value(
                        iter, self.individual_birth_day_posn, self.temp_individual_birth_day)
                    self.individual_treestore.set_value(
                        iter, self.individual_death_date_posn, self.temp_individual_death_date)
                    self.individual_treestore.set_value(
                        iter, self.individual_death_year_posn, self.temp_individual_death_year)
                    self.individual_treestore.set_value(
                        iter, self.individual_death_month_posn, self.temp_individual_death_month)
                    self.individual_treestore.set_value(
                        iter, self.individual_death_day_posn, self.temp_individual_death_day)
                    self.individual_treestore.set_value(
                        iter, self.individual_family_pointers_posn, self.temp_individual_family_pointers)
                    self.individual_treestore.set_value(
                        iter, self.individual_parent_pointers_posn, self.temp_individual_parent_pointers)
            result = self.treerow_search_and_copy(
                model, model.iter_children(iter), func, data)
            if result:
                if model == self.individual_treestore:
                    self.individual_treestore.set_value(
    ...
    def add_note(self, widget):
        ...
        raw_gedcom_iter = raw_gedcom_treestore.append(
            None, ["0", self.next_note_pointer, "NOTE", ""])
        raw_gedcom_iter = raw_gedcom_treestore.append(
            None, ["1", " ", "CONC", "Comment line starts here..."])
        raw_gedcom_iter = raw_gedcom_treestore.append(
            None, ["1", " ", "CONC", "and continues on next line with no breaks."])
        raw_gedcom_iter = raw_gedcom_treestore.append(
            None, ["1", " ", "CONT", "Fresh comment line starts here..."])

        new_note_iter = self.note_treestore.prepend(
            None, ["", "NEWNOTE", self.next_note_pointer, "Comment line starts here...and continues on next line with no breaks.\nFresh comment line starts here..."])

        raw_gedcom_treeview = self.raw_gedcom_edit(
            raw_gedcom_treestore, self.note_treestore, new_note_iter, window)

        self.save_raw_gedcom(
            raw_gedcom_treestore, self.note_treestore, new_note_iter)
    ...
    def add_individual(self, widget):
        ...
        new_individual_iter = self.individual_treestore.prepend(
            None, ["", "NEWINDIVIDUAL", self.next_individual_pointer, "GivenNames", "LastName", "Sex", "BirthDate", "BirthYear", "BirthMonth", "BirthDay", "DeathDate", "DeathYear", "DeathMonth", "DeathDay", "", ""])

        raw_gedcom_treeview = self.raw_gedcom_edit(
            raw_gedcom_treestore, self.individual_treestore, new_individual_iter, window)

        self.save_raw_gedcom(
            raw_gedcom_treestore, self.individual_treestore, new_individual_iter)
    ...
    def save_raw_gedcom(self, raw_gedcom_treestore, input_treestore, input_iter):
        ...
        for row in raw_gedcom_treestore:
            if row[1] == " ":
                ...
                if row[0] != None:
                    new_values = new_values + row[0] + " " + \
                        row[1] + " " + row[2] + " " + row[3] + "\n"
                else:
                    print "not a valid row!"
        if new_values[-1] == '\n':
            new_values = new_values[:-1]
        input_treestore.set_value(
            input_iter, self.generic_raw_gedcom_posn, new_values)
    ...
    def add_parent(self, parent_type):
        ...
        individual_pointer = individual_treestore.get_value(
            individual_iter, self.individual_pointer_posn)
        individual_parent_pointers = individual_treestore.get_value(
            individual_iter, self.individual_parent_pointers_posn)
        ...
        raw_gedcom_iter = raw_gedcom_treestore.append(
            None, ["1", " ", "FAMC", "@Fnnnn@"])
        raw_gedcom_iter = raw_gedcom_treestore.append(
            None, ["1", " ", "FAMS", self.next_family_pointer])
        raw_gedcom_iter = raw_gedcom_treestore.append(
            None, ["1", " ", "NOTE", "@Nnnnn@"])

        raw_gedcom = self.individual_treestore.get_value(
            individual_iter, self.generic_raw_gedcom_posn)
        new_raw_gedcom = raw_gedcom + "\n" + \
            "1 FAMS " + self.next_family_pointer
        self.individual_treestore.set_value(
            individual_iter, self.individual_raw_gedcom_posn, new_raw_gedcom)

        families = self.individual_treestore.get_value(
            individual_iter, self.individual_family_pointers_posn)
        if families:
        ...
        self.individual_treestore.set_value(
            individual_iter, self.individual_family_pointers_posn, new_families)

        new_parent_iter = self.individual_treestore.insert_before(None, None, ["", "NEWPARENT", self.next_individual_pointer, "GivenNames", "LastName",
                                                                               "Sex", "BirthDate", "BirthYear", "BirthMonth", "BirthDay", "DeathDate", "DeathYear", "DeathMonth", "DeathDay", self.next_family_pointer, ""])

        raw_gedcom_treeview = self.raw_gedcom_edit(
            raw_gedcom_treestore, self.individual_treestore, new_parent_iter, window)
        ...
        add_spouse_iter = self.family_treestore.prepend(None, [family_raw_gedcom, "NEWFAMILY", self.next_family_pointer, "", "HusbandGivenNames",
                                                               "HusbandLastName", "", "WifeGivenNames", "WifeLastName", "MarriageDate", "MarriageYear", "MarriageMonth", "MarriageDay", ""])

        self.save_raw_gedcom(
            raw_gedcom_treestore, self.individual_treestore, new_parent_iter)
    ...
    def delete_individual(self, widget):
        # have to remove spouse from family and child from family and remove
        # from dict
        individual_treestore,  individual_iter = self.individual_treeview.get_selection(
            ).get_selected()
        individual_pointer = individual_treestore.get_value(
            individual_iter, self.individual_pointer_posn)
        individual_family_pointers = individual_treestore.get_value(
            individual_iter, self.individual_family_pointers_posn)

        # if deleted individual is a husband/wife, remove HUSB/WIFE tag from each
        # family raw gedcom and also set individual's name/pointer to empty in
        # each family
        if individual_family_pointers:
            ...
            for family in family_pointers:
                if self.family_dict.has_key(family):
                    ...
                    self.delete_raw_gedcom_line(
                        self.temp_family_raw_gedcom, ["HUSB", "WIFE"], individual_pointer)
                    self.family_treestore.set_value(
                        self.generic_iter, self.generic_raw_gedcom_posn, self.new_raw_gedcom)
        ...
        # if deleted individual is a child in a family, remove CHIL tag in family
        # raw gedcom and also remove child pointer from family children pointer
        # list
        if self.family_dict.has_key(individual_parent_pointers):
            self.find_family(individual_parent_pointers, self.family_treeview)
            self.delete_raw_gedcom_line(
                self.temp_family_raw_gedcom, "CHIL", individual_pointer)
            self.family_treestore.set_value(
                self.generic_iter, self.generic_raw_gedcom_posn, self.new_raw_gedcom)
            self.delete_pointer_list(
                self.temp_family_children_pointers, individual_pointer)
            self.family_treestore.set_value(
                self.generic_iter, self.family_children_pointers_posn, self.new_pointer_list)
        else:
            print "No child family to clean up!"

        self.temp_individual_pointer = individual_pointer
        result = self.treerow_search_and_delete(self.individual_treestore, self.individual_treestore.iter_children(
            None), self.match_func, (self.individual_pointer_posn, self.temp_individual_pointer))
    ...
    def delete_family(self, widget):
        family_treestore,  family_iter = self.family_treeview.get_selection(
            ).get_selected()

        family_pointer = family_treestore.get_value(
            family_iter, self.family_pointer_posn)
        family_husband_pointer = family_treestore.get_value(
            family_iter, self.family_husband_pointer_posn)
        family_wife_pointer = family_treestore.get_value(
            family_iter, self.family_wife_pointer_posn)
        family_children_pointers = family_treestore.get_value(
            family_iter, self.family_children_pointers_posn)
        ...
        if family_husband_pointer:
            self.find_individual(
                family_husband_pointer, self.individual_treeview)
            self.delete_raw_gedcom_line(
                self.temp_individual_raw_gedcom, "FAMS", family_pointer)
            self.individual_treestore.set_value(
                self.generic_iter, self.generic_raw_gedcom_posn, self.new_raw_gedcom)
            self.delete_pointer_list(
                self.temp_individual_family_pointers, family_pointer)
            self.individual_treestore.set_value(
                self.generic_iter, self.individual_family_pointers_posn, self.new_pointer_list)
        ...
        if family_children_pointers:
            ...
            for child in child_pointers:
                ...
                self.delete_raw_gedcom_line(
                    self.temp_individual_raw_gedcom, "FAMC", family_pointer)
                self.individual_treestore.set_value(
                    self.generic_iter, self.generic_raw_gedcom_posn, self.new_raw_gedcom)
                self.delete_pointer_list(
                    self.temp_individual_parent_pointers, family_pointer)
                self.individual_treestore.set_value(
                    self.generic_iter, self.individual_parent_pointers_posn, self.new_pointer_list)
    ...
    def delete_raw_gedcom_line(self, input_gedcom, check_tag, check_value):
        ...
        for raw_gedcom_line in raw_gedcom.split("\n"):
            ...
            if tag in check_tag and values == check_value:
                ...
                if pointer == " ":
                    self.new_raw_gedcom = self.new_raw_gedcom + \
                        level + " " + tag + " " + values + "\n"
                else:
                    self.new_raw_gedcom = self.new_raw_gedcom + level + \
                        " " + pointer + " " + tag + " " + values + "\n"
    ...
    def add_family(self, widget):
        ...
        raw_gedcom_iter = raw_gedcom_treestore.append(
            None, ["0", self. next_family_pointer, "FAM", ""])
        raw_gedcom_iter = raw_gedcom_treestore.append(
            None, ["1", " ", "HUSB", "@Innnn@"])
        raw_gedcom_iter = raw_gedcom_treestore.append(
            None, ["1", " ", "WIFE", "@Innnn@"])
        ...
        family_treestore_iter = self.family_treestore.prepend(
            None, ["", "FAMILY", self.next_family_pointer, "", "HusbandGivenNames", "HusbandLastName", "", "WifeGivenNames", "WifeLastName", "MarriageDate", "MarriageYear", "MarriageMonth", "MarriageDay", ""])

        raw_gedcom_treeview = self.raw_gedcom_edit(
            raw_gedcom_treestore, self.family_treestore, family_treestore_iter, window)

        self.save_raw_gedcom(
            raw_gedcom_treestore, self.family_treestore, family_treestore_iter)
    ...
    def add_spouse(self, widget):
        ...
        if not individual_iter:
            self.on_show_note(
                self.window, "ERROR: Must select spouse to attach to!", "OK")
            return

        individual_pointer = individual_treestore.get_value(
            individual_iter, self.individual_pointer_posn)
        individual_given_names = individual_treestore.get_value(
            individual_iter, self.individual_given_names_posn)
        individual_last_name = individual_treestore.get_value(
            individual_iter, self.individual_last_name_posn)
        individual_sex = individual_treestore.get_value(
            individual_iter, self.individual_sex_posn)
        ...
        new_individual_iter = self.individual_treestore.insert_after(
            None, None, ["", "NEWINDIVIDUAL", self.next_individual_pointer, "GivenNames", "LastName", "F", "BirthDate", "BirthYear", "BirthMonth", "BirthDay", "DeathDate", "DeathYear", "DeathMonth", "DeathDay", self.next_family_pointer, ""])
        ...
        if individual_sex == "M":
            self.individual_treestore.set_value(
                individual_iter, self.individual_type_posn, "HUSBAND")
            new_spouse_iter = self.individual_treestore.insert_after(individual_iter, None, [
                                                                     "", "NEWWIFE", self.next_individual_pointer, "GivenNames", "LastName", "F", "BirthDate", "BirthYear", "BirthMonth", "BirthDay", "DeathDate", "DeathYear", "DeathMonth", "DeathDay", self.next_family_pointer, ""])
        else:
            self.individual_treestore.set_value(
                individual_iter, self.individual_type_posn, "WIFE")
            new_spouse_iter = self.individual_treestore.insert_after(individual_iter, None, [
                                                                     "", "NEWHUSBAND", self.next_individual_pointer, "GivenNames", "LastName", "M", "BirthDate", "BirthYear", "BirthMonth", "BirthDay", "DeathDate", "DeathYear", "DeathMonth", "DeathDay", self.next_family_pointer, ""])

        raw_gedcom_treeview = self.raw_gedcom_edit(
            raw_gedcom_treestore, self.individual_treestore, new_spouse_iter, window)
        ...
        new_family_iter = self.family_treestore.prepend(None, [family_raw_gedcom, "NEWFAMILY", self.next_family_pointer, "", "HusbandGivenNames",
                                                               "HusbandLastName", "", "WifeGivenNames", "WifeLastName", "MarriageDate", "MarriageYear", "MarriageMonth", "MarriageDay", ""])

        # dare is this needed? YES!
        self.save_raw_gedcom(
            raw_gedcom_treestore, self.individual_treestore, new_spouse_iter)

        if individual_sex == "M":
            self.family_treestore.set_value(
                new_family_iter, self.family_husband_given_names_posn, individual_given_names)
            self.family_treestore.set_value(
                new_family_iter, self.family_husband_last_name_posn, individual_last_name)
            self.family_treestore.set_value(
                new_family_iter, self.family_husband_pointer_posn, individual_pointer)
            self.family_treestore.set_value(
                new_family_iter, self.family_wife_pointer_posn, self.next_individual_pointer)
        else:
            self.family_treestore.set_value(
                new_family_iter, self.family_wife_given_names_posn, individual_given_names)
            self.family_treestore.set_value(
                new_family_iter, self.family_wife_last_name_posn, individual_last_name)
            self.family_treestore.set_value(
                new_family_iter, self.family_wife_pointer_posn, individual_pointer)
            self.family_treestore.set_value(
                new_family_iter, self.family_husband_pointer_posn, self.next_individual_pointer)
    ...
    def copy_individual(self, output_iter, input_iter):
        ...
        temp_individual_pointer = self.individual_treestore.get_value(
            input_iter, self.individual_pointer_posn)
        temp_individual_raw_gedcom = self.individual_treestore.get_value(
            input_iter, self.individual_raw_gedcom_posn)
        temp_individual_given_names = self.individual_treestore.get_value(
            input_iter, self.individual_given_names_posn)
        temp_individual_last_name = self.individual_treestore.get_value(
            input_iter, self.individual_last_name_posn)
        temp_individual_sex = self.individual_treestore.get_value(
            input_iter, self.individual_sex_posn)
        temp_individual_birth_date = self.individual_treestore.get_value(
            input_iter, self.individual_birth_date_posn)
        temp_individual_birth_year = self.individual_treestore.get_value(
            input_iter, self.individual_birth_year_posn)
        temp_individual_birth_month = self.individual_treestore.get_value(
            input_iter, self.individual_birth_month_posn)
        temp_individual_birth_day = self.individual_treestore.get_value(
            input_iter, self.individual_birth_day_posn)
        temp_individual_death_date = self.individual_treestore.get_value(
            input_iter, self.individual_death_date_posn)
        temp_individual_death_year = self.individual_treestore.get_value(
            input_iter, self.individual_death_year_posn)
        temp_individual_death_month = self.individual_treestore.get_value(
            input_iter, self.individual_death_month_posn)
        temp_individual_death_day = self.individual_treestore.get_value(
            input_iter, self.individual_death_day_posn)
        temp_individual_family_pointers = self.individual_treestore.get_value(
            input_iter, self.individual_family_pointers_posn)
        temp_individual_parent_pointers = self.individual_treestore.get_value(
            input_iter, self.individual_parent_pointers_posn)

        self.individual_treestore.set_value(
            output_iter, self.individual_raw_gedcom_posn, temp_individual_raw_gedcom)
        self.individual_treestore.set_value(
            output_iter, self.individual_given_names_posn, temp_individual_given_names)
        self.individual_treestore.set_value(
            output_iter, self.individual_last_name_posn, temp_individual_last_name)
        self.individual_treestore.set_value(
            output_iter, self.individual_sex_posn, temp_individual_sex)
        self.individual_treestore.set_value(
            output_iter, self.individual_birth_date_posn, temp_individual_birth_date)
        self.individual_treestore.set_value(
            output_iter, self.individual_birth_year_posn, temp_individual_birth_year)
        self.individual_treestore.set_value(
            output_iter, self.individual_birth_month_posn, temp_individual_birth_month)
        self.individual_treestore.set_value(
            output_iter, self.individual_birth_day_posn, temp_individual_birth_day)
        self.individual_treestore.set_value(
            output_iter, self.individual_death_date_posn, temp_individual_death_date)
        self.individual_treestore.set_value(
            output_iter, self.individual_death_year_posn, temp_individual_death_year)
        self.individual_treestore.set_value(
            output_iter, self.individual_death_month_posn, temp_individual_death_month)
        self.individual_treestore.set_value(
            output_iter, self.individual_death_day_posn, temp_individual_death_day)
        self.individual_treestore.set_value(
            output_iter, self.individual_family_pointers_posn, temp_individual_family_pointers)
        self.individual_treestore.set_value(
            output_iter, self.individual_parent_pointers_posn, temp_individual_parent_pointers)
    ...
    def generic_on_selection_changed(self, selection):
        ...
        if input_iter:
            raw_gedcom = input_treestore.get_value(
                input_iter, self.generic_raw_gedcom_posn)
            for raw_gedcom_line in raw_gedcom.split("\n"):
                line_element = raw_gedcom_line.split(" ", 2)
                level = line_element[0]
                if len(line_element) == 2:
        ...
        treeview = self.raw_gedcom_edit(
            raw_gedcom_treestore, input_treestore, input_iter, window)
    ...
    def raw_gedcom_edit(self, raw_gedcom_treestore, input_treestore, input_iter, window):
        ...
        level_cell.connect(
            'edited', self.raw_gedcom_level_edited_cb, raw_gedcom_treestore, input_treestore, input_iter)
        pointer_cell = gtk.CellRendererText()
        pointer_cell.set_property('editable', True)
        self.set_cell_style(pointer_cell)
        pointer_cell.connect(
            'edited', self.raw_gedcom_pointer_edited_cb, raw_gedcom_treestore, input_treestore, input_iter)
        tag_cell = gtk.CellRendererText()
        tag_cell.set_property('editable', True)
        self.set_cell_style(tag_cell)
        tag_cell.connect('edited', self.raw_gedcom_tag_edited_cb,
                         raw_gedcom_treestore, input_treestore, input_iter)
        values_cell = gtk.CellRendererText()
        values_cell.set_property('editable', True)
        self.set_cell_style(values_cell)
        values_cell.connect(
            'edited', self.raw_gedcom_values_edited_cb, raw_gedcom_treestore, input_treestore, input_iter)
        raw_gedcom_treeview.connect(
            'cursor-changed', self.raw_gedcom_cursor_changed_cb)
        ...
        # hey, the first letters of the commands are shortcuts, but are they
        # correct and work?
        actiongroup2.add_actions([('Insert Raw Gedcom Row Before', None, '_Insert Raw Gedcom Row Before', None, None, self.raw_gedcom_row_insert_before),
                                  ('Insert Raw Gedcom Row After', None, '_Insert Raw Gedcom Row After',
                                   None, None, self.raw_gedcom_row_insert_after),
    ...
    def raw_gedcom_row_insert_before(self, widget, params):
        ...
        input_iter = params[2]
        raw_gedcom_treestore,  raw_gedcom_iter = raw_gedcom_treeview.get_selection(
            ).get_selected()
        new_raw_gedcom_iter = raw_gedcom_treestore.insert_before(
            None, raw_gedcom_iter, [" ", " ", " ", " "])
        self.save_raw_gedcom(raw_gedcom_treestore, input_treestore, input_iter)
    ...
    def raw_gedcom_row_insert_after(self, widget, params):
        ...
        new_raw_gedcom_iter = raw_gedcom_treestore.insert_after(
            None, raw_gedcom_iter, [" ", " ", " ", " "])
        self.save_raw_gedcom(raw_gedcom_treestore, input_treestore, input_iter)
    ...
    def raw_gedcom_row_delete(self, widget, params):
        ...
        level = raw_gedcom_treestore.get_value(
            raw_gedcom_iter, self.raw_gedcom_level_posn)
        pointer = raw_gedcom_treestore.get_value(
            raw_gedcom_iter, self.raw_gedcom_pointer_posn)
        tag = raw_gedcom_treestore.get_value(
            raw_gedcom_iter, self.raw_gedcom_tag_posn)
        values = raw_gedcom_treestore.get_value(
            raw_gedcom_iter, self.raw_gedcom_values_posn)
    ...
    def raw_gedcom_cursor_changed_cb(self, raw_gedcom_treeview):
        ...
        tag = raw_gedcom_treestore.get_value(
            raw_gedcom_iter, self.raw_gedcom_tag_posn)
        value = raw_gedcom_treestore.get_value(
            raw_gedcom_iter, self.raw_gedcom_values_posn)
        if colname in ("Values") and value[:1] == "@":
            if tag in ("INDI", "HUSB", "WIFE", "CHIL"):
                ...
                if self.individual_dict.has_key(individual_pointer):
                    self.set_cursor(
                        individual_pointer, self.individual_treeview)
            if tag[:3] == "FAM":
            ...
            if tag == "REPO":
                ...
                if self.repository_dict.has_key(repository_pointer):
                    self.set_cursor(
                        repository_pointer, self.repository_treeview)
            if tag == "OBJE":
            ...
            if tag == "SUBN":
                ...
                if self.submission_dict.has_key(submission_pointer):
                    self.set_cursor(
                        submission_pointer, self.submission_treeview)
    ...
    def raw_gedcom_level_edited_cb(self, cell, path, new_text, raw_gedcom_treestore, input_treestore, input_iter):
        ...
        try:
            ...
            self.on_show_note(
                self.window, "ERROR: level value must be numeric integer", "OK")
            return

        if int(level) != 0 and pointer != " ":
            self.on_show_note(
                self.window, "ERROR: Pointer value only valid for level 0!\n" + pointer, "OK")
            return
    ...
    def raw_gedcom_pointer_edited_cb(self, cell, path, new_text, raw_gedcom_treestore, input_treestore, input_iter):
        raw_gedcom_treestore[path][
            self.raw_gedcom_pointer_posn] = string.upper(new_text)
        pointer = raw_gedcom_treestore[path][self.raw_gedcom_pointer_posn]
        level = raw_gedcom_treestore[path][self.raw_gedcom_level_posn]
        ...
        if input_treestore == self.individual_treestore:
            if not self.individual_dict.has_key(pointer) and pointer != "":
                ...
                self.on_show_note(
                    self.window, "ERROR: individual pointer does NOT exist in GEDCOM file!\n" + pointer, "OK")
                return
    ...
    def raw_gedcom_tag_edited_cb(self, cell, path, new_text, raw_gedcom_treestore, input_treestore, input_iter):
        raw_gedcom_treestore[path][
            self.raw_gedcom_tag_posn] = string.upper(new_text)
        tag = raw_gedcom_treestore[path][self.raw_gedcom_tag_posn]

        if not self.valid_tags.has_key(tag):
            self.on_show_note(
                self.window, "ERROR: TAG value is not valid", "OK")
            return
    ...
    def raw_gedcom_values_edited_cb(self, cell, path, new_text, raw_gedcom_treestore, input_treestore, input_iter):
        ...
        if input_treestore == self.individual_treestore:
            ...
            individual_pointer = input_treestore.get_value(
                input_iter, self.individual_pointer_posn)
        if input_treestore == self.family_treestore:
            print "raw edit on family treestore"
            family_pointer = input_treestore.get_value(
                input_iter, self.family_pointer_posn)

        if tag == "NAME":
            name = string.split(new_text, '/')
            if len(name) < 2:
                self.on_show_note(
                    self.window, "ERROR: NAME tag requires /lastname/", "OK")
                return
            else:
                first = string.strip(name[0])
                last = string.strip(name[1])
                input_treestore.set_value(
                    input_iter, self.individual_given_names_posn, first)
                input_treestore.set_value(
                    input_iter, self.individual_last_name_posn, last)

                individual_pointer = input_treestore.get_value(
                    input_iter, self.individual_pointer_posn)
                individual_sex = input_treestore.get_value(
                    input_iter, self.individual_sex_posn)
                individual_family_pointers = string.split(
                    input_treestore.get_value(input_iter, self.individual_family_pointers_posn), ",")
                # dare, now does family pointers get updated?
                for family_pointer in individual_family_pointers:
                    if self.family_dict.has_key(family_pointer):
                        ...
                        if individual_sex == "M":
                            self.family_treestore.set_value(
                                self.generic_iter, self.family_husband_given_names_posn, first)
                            self.family_treestore.set_value(
                                self.generic_iter, self.family_husband_last_name_posn, last)
                        else:
                            self.family_treestore.set_value(
                                self.generic_iter, self.family_wife_given_names_posn, first)
                            self.family_treestore.set_value(
                                self.generic_iter, self.family_wife_last_name_posn, last)

        if tag == "SEX":
            sex = string.upper(new_text[:1])
            if sex not in ('M', 'F'):
                self.on_show_note(
                    self.window, "ERROR: SEX tag must be either 'M' or 'F'", "OK")
                return
            else:
                input_treestore.set_value(
                    input_iter, self.individual_sex_posn, sex)
        ...
        if tag == "DATE":
            ...
            for line in range(int(path), 0, -1):
                ...
                if old_level != new_level:
                    if new_tag == "BIRT":
                        input_treestore.set_value(
                            input_iter, self.individual_birth_year_posn, year)
                        input_treestore.set_value(
                            input_iter, self.individual_birth_month_posn, month)
                        input_treestore.set_value(
                            input_iter, self.individual_birth_day_posn, day)
                    if new_tag == "DEAT":
                        input_treestore.set_value(
                            input_iter, self.individual_death_year_posn, year)
                        input_treestore.set_value(
                            input_iter, self.individual_death_month_posn, month)
                        input_treestore.set_value(
                            input_iter, self.individual_death_day_posn, day)
                    if new_tag == "MARR":
                        input_treestore.set_value(
                            input_iter, self.family_marriage_year_posn, year)
                        input_treestore.set_value(
                            input_iter, self.family_marriage_month_posn, month)
                        input_treestore.set_value(
                            input_iter, self.family_marriage_day_posn, day)
                    break
        # if tag in ("INDI", "HUSB", "WIFE", "CHIL"):
        if tag == "HUSB":
            pointer = new_text
            if not self.individual_dict.has_key(pointer) and pointer != "":
                ...
                input_treestore.set_value(
                    input_iter, self.family_husband_pointer_posn, new_text)
                self.find_individual(new_text, self.individual_treeview)
                input_treestore.set_value(
                    input_iter, self.family_husband_given_names_posn, self.temp_individual_given_names)
                input_treestore.set_value(
                    input_iter, self.family_husband_last_name_posn, self.temp_individual_last_name)

                # dare, do you REPLACE existing indi family info, or APPEND new stuff to
                # it? and what about the original spouse?
                ...
                self.individual_treestore.set_value(
                    self.generic_iter, self.generic_raw_gedcom_posn, new_husband_raw_gedcom)
        if tag == "WIFE":
            pointer = new_text
            if not self.individual_dict.has_key(pointer) and pointer != "":
                print "ERROR: individual pointer does NOT exist in GEDCOM file!", pointer
                ...
                input_treestore.set_value(
                    input_iter, self.family_wife_pointer_posn, new_text)
                self.find_individual(new_text, self.individual_treeview)
                input_treestore.set_value(
                    input_iter, self.family_wife_pointer_posn, new_text)
                input_treestore.set_value(
                    input_iter, self.family_wife_given_names_posn, self.temp_individual_given_names)
                input_treestore.set_value(
                    input_iter, self.family_wife_last_name_posn, self.temp_individual_last_name)

                # dare, do you REPLACE existing indi family info, or APPEND new stuff to it?
                # set remove family pointer from original wife individual family pointer
                # list and also remove FAMS entry from raw gedcom
                self.find_individual(old_values, self.individual_treeview)
                self.delete_pointer_list(
                    self.temp_individual_family_pointers, family_pointer)
                #self.individual_treestore.set_value(self.generic_iter, self.individual_family_pointers_posn, "")
                ...
                # append current family to family pointer of new wife individual and also
                # append FAMS entry to raw gedcom
                self.find_individual(new_text, self.individual_treeview)
                self.append_pointer_list(
                    self.temp_individual_family_pointers, family_pointer)
                ...
                #self.individual_treestore.set_value(self.generic_iter, self.generic_raw_gedcom_posn, self.new_raw_gedcom)
                self.individual_treestore.set_value(
                    self.generic_iter, self.generic_raw_gedcom_posn, new_wife_raw_gedcom)
        if tag == "CHIL":
            pointer = new_text
            if not self.individual_dict.has_key(pointer) and pointer != "":
                print "ERROR: individual pointer does NOT exist in GEDCOM file!", pointer
                ...
                new_children_pointers = input_treestore.get_value(
                    input_iter, self.family_children_pointers_posn)
                new_children_pointers = new_children_pointers + "," + new_text
                input_treestore.set_value(
                    input_iter, self.family_children_pointers_posn, new_children_pointers)
                self.find_individual(new_text, self.individual_treeview)
                self.individual_treestore.set_value(
                    self.generic_iter, self.individual_parent_pointers_posn, family_pointer)
                self.replace_raw_gedcom_line(
                    self.temp_individual_raw_gedcom, family_pointer, "FAMC", None)
                self.individual_treestore.set_value(
                    self.generic_iter, self.generic_raw_gedcom_posn, self.new_raw_gedcom)
        if tag[:3] == "FAM":
            pointer = new_text
        ...
        if tag == "NOTE":
            ...
            if not self.note_dict.has_key(pointer) and pointer != "":
                ...
                self.on_show_note(
                    self.window, "ERROR: note pointer does NOT exist in GEDCOM file!\n" + pointer, "OK")
                return
        if tag in ["CONC", "CONT"]:
            notes = " "
            for raw_gedcom_line in raw_gedcom_treestore:
                ...
                if int(level) == 1 and tag == "CONT":
                    notes = notes + "\n" + values
            self.note_treestore.set_value(
                input_iter, self.note_text_posn, notes)

        self.save_raw_gedcom(raw_gedcom_treestore, input_treestore, input_iter)

        if input_treestore == self.individual_treestore:
            self.temp_individual_pointer = input_treestore.get_value(
                input_iter, self.individual_pointer_posn)
            self.temp_individual_raw_gedcom = input_treestore.get_value(
                input_iter, self.individual_raw_gedcom_posn)
            self.temp_individual_given_names = input_treestore.get_value(
                input_iter, self.individual_given_names_posn)
            self.temp_individual_last_name = input_treestore.get_value(
                input_iter, self.individual_last_name_posn)
            self.temp_individual_sex = input_treestore.get_value(
                input_iter, self.individual_sex_posn)
            self.temp_individual_birth_date = input_treestore.get_value(
                input_iter, self.individual_birth_date_posn).lstrip()
            self.temp_individual_birth_year = input_treestore.get_value(
                input_iter, self.individual_birth_year_posn)
            self.temp_individual_birth_month = input_treestore.get_value(
                input_iter, self.individual_birth_month_posn)
            self.temp_individual_birth_day = input_treestore.get_value(
                input_iter, self.individual_birth_day_posn)
            self.temp_individual_death_date = input_treestore.get_value(
                input_iter, self.individual_death_date_posn).lstrip()
            self.temp_individual_death_year = input_treestore.get_value(
                input_iter, self.individual_death_year_posn)
            self.temp_individual_death_month = input_treestore.get_value(
                input_iter, self.individual_death_month_posn)
            self.temp_individual_death_day = input_treestore.get_value(
                input_iter, self.individual_death_day_posn)
            self.temp_individual_family_pointers = input_treestore.get_value(
                input_iter, self.individual_family_pointers_posn)
            self.temp_individual_parent_pointers = input_treestore.get_value(
                input_iter, self.individual_parent_pointers_posn)

            match_iter = self.treerow_search_and_copy(self.individual_treestore, self.individual_treestore.iter_children(
                None), self.match_func, (self.individual_pointer_posn, self.temp_individual_pointer))
    ...
    def on_show_note(self, window, message, choice):
        if hildon_flag == True:
            dialog = hildon.Note(
                "confirmation", (window, message, gtk.STOCK_DIALOG_INFO))
...
def write_ini_data(self, section_name, option_name, option_value):
    inifile = open(os.path.expanduser(ini_file), 'w')
...
def get_ini_data(self):
    ...
    try:
        ...
        self.on_show_note(
            self.window, "ERROR: mgedcom.ini file missing! Creating minimal version.", "OK")
        print "ini data file (initialization parameters) are missing!"
        inifile = open(os.path.expanduser(ini_file), 'w')
        ...
        try:
            ...
            write_ini_data(self.window, 'Report', 'graph_title', graph_title)

        try:
            gedcom_dir = config.get('Report', 'gedcom_dir')
        except ConfigParser.NoOptionError:
            write_ini_data(self.window, 'Report', 'gedcom_dir', gedcom_dir)

        try:
            dot_dir = config.get('Report', 'dot_dir')
        except ConfigParser.NoOptionError:
            write_ini_data(self.window, 'Report', 'dot_dir', dot_dir)

        try:
            graph_direction = config.get('Report', 'graph_direction')
            # if config.has_option('Report','graph_direction'):
        except ConfigParser.NoOptionError:
            write_ini_data(
                self.window, 'Report', 'graph_direction', graph_direction)
        else:
        ...
        try:
            ...
            write_ini_data(
                self.window, 'Report', 'dot_convert_type', dot_convert_type)
        else:
            convert_radioaction = actiongroup.get_action(dot_convert_type)
            convert_radioaction.set_active(True)

        try:
            relation_style = config.get('Report', 'relation_style')
        except ConfigParser.NoOptionError:
            write_ini_data(
                self.window, 'Report', 'relation_style', relation_style)
        else:
        ...
        try:
            ...
            write_ini_data(
                self.window, 'Report', 'parents_dot_flag', parents_dot_flag)
        else:
            parents_toggleaction = actiongroup.get_action('Parents')
            parents_toggleaction.set_active(parents_dot_flag)

        try:
            siblings_dot_flag = config.getboolean(
                'Report', 'siblings_dot_flag')
        except ConfigParser.NoOptionError:
            write_ini_data(
                self.window, 'Report', 'siblings_dot_flag', siblings_dot_flag)
        else:
        ...
        try:
            ...
            write_ini_data(
                self.window, 'Report', 'spouses_dot_flag', spouses_dot_flag)
        else:
            spouses_toggleaction = actiongroup.get_action('Spouses')
            spouses_toggleaction.set_active(spouses_dot_flag)

        try:
            children_dot_flag = config.getboolean(
                'Report', 'children_dot_flag')
        except ConfigParser.NoOptionError:
            write_ini_data(
                self.window, 'Report', 'children_dot_flag', children_dot_flag)
        else:
            children_toggleaction = actiongroup.get_action('Children')
            children_toggleaction.set_active(children_dot_flag)

        try:
            everyone_dot_flag = config.getboolean(
                'Report', 'everyone_dot_flag')
        except ConfigParser.NoOptionError:
            write_ini_data(
                self.window, 'Report', 'everyone_dot_flag', everyone_dot_flag)
        else:
            everyone_toggleaction = actiongroup.get_action('Everyone')
            everyone_toggleaction.set_active(everyone_dot_flag)

        try:
            living_dates_flag = config.getboolean(
                'Report', 'living_dates_flag')
        except ConfigParser.NoOptionError:
            write_ini_data(
                self.window, 'Report', 'living_dates_flag', living_dates_flag)
        else:
            living_toggleaction = actiongroup.get_action('Living')
            living_toggleaction.set_active(living_dates_flag)

        try:
            individual_show_flag = config.getboolean(
                'Report', 'individual_show_flag')
        except ConfigParser.NoOptionError:
            write_ini_data(
                self.window, 'Report', 'individual_show_flag', individual_show_flag)
        else:
        ...
        try:
            ...
            write_ini_data(
                self.window, 'Report', 'family_show_flag', family_show_flag)
        else:
        ...
        try:
            ...
            write_ini_data(
                self.window, 'Report', 'note_show_flag', note_show_flag)
        else:
            note_toggleaction = actiongroup.get_action('Notes')
            note_toggleaction.set_active(note_show_flag)

        try:
            submitter_show_flag = config.getboolean(
                'Report', 'submitter_show_flag')
        except ConfigParser.NoOptionError:
            write_ini_data(
                self.window, 'Report', 'submitter_show_flag', submitter_show_flag)
        else:
            submitter_toggleaction = actiongroup.get_action('Submitters')
            submitter_toggleaction.set_active(submitter_show_flag)

        try:
            repository_show_flag = config.getboolean(
                'Report', 'repository_show_flag')
        except ConfigParser.NoOptionError:
            write_ini_data(
                self.window, 'Report', 'repository_show_flag', repository_show_flag)
        else:
        ...
        try:
            ...
            write_ini_data(
                self.window, 'Report', 'source_show_flag', source_show_flag)
        else:
        ...
        try:
            ...
            write_ini_data(
                self.window, 'Report', 'object_show_flag', object_show_flag)
        else:
            object_toggleaction = actiongroup.get_action('Objects')
            object_toggleaction.set_active(object_show_flag)

        try:
            submission_show_flag = config.getboolean(
                'Report', 'submission_show_flag')
        except ConfigParser.NoOptionError:
            write_ini_data(
                self.window, 'Report', 'submission_show_flag', submission_show_flag)
        else:
        ...
        try:
            ...
            write_ini_data(
                self.window, 'Report', 'custom_show_flag', custom_show_flag)
        else:
        ...
        try:
            ...
            write_ini_data(self.window, 'Report', 'font_size', font_size)

        try:
            traverse_level_max = float(
                config.get('Report', 'traverse_level_max'))
        except ConfigParser.NoOptionError:
            write_ini_data(
                self.window, 'Report', 'traverse_level_max', traverse_level_max)
...
class main_window:
    ...
    def __init__(self):
        ...
        self.main_window.connect(
            "window-state-event", on_window_state_change, self.main_window)
        ...
        if not os.path.exists("~/.mgedcom"):
            ...
            os.system(
                'cp -p /usr/lib/mgedcom/home/user/.mgedcom/fake.* ~/.mgedcom')
            os.system(
                'cp -p /usr/lib/mgedcom/home/user/.mgedcom/mgedcom.ini ~/.mgedcom')

        if not os.path.exists("~/.mgedcom/mgedcom.ini"):
            os.system(
                'cp -p /usr/lib/mgedcom/home/user/.mgedcom/mgedcom.ini ~/.mgedcom')
